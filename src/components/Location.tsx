                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                    <div className="w-full h-auto bg-gray-200 rounded-lg p-8">
                        ...
                        <form className='space-y-6' onSubmit={handleSubmit}>
                            ...
                            <button type="submit" className="w-full bg-red-700 text-white py-2 rounded-md hover:bg-red-800 transition duration-300" disabled={loading}>
                                {loading ? 'Enviando...' : 'Enviar'}
                            </button>
                        </form>
                        {loading && <p className="text-center text-black mt-4">Enviando...</p>}
