...
export default function About() {
    ...
    return (
        <div className="bg-wite w-full flex flex-col items-center min-h-screen">
            <div className="flex flex-row md:flex-col items-center justify-center p-4 pt-10 md:pt-28 space-x-4 md:space-x-0 md:space-y-4">
                <button
            ...
            <div className={`flex flex-col items-center justify-center mt-5 md:mt-20 p-4 md:p-8 bg-white shadow-lg rounded-lg w-full max-w-2xl md:max-w-5xl transition-opacity duration-500 ${fade ? 'opacity-0' : 'opacity-100'}`}>
                {renderContent()}
